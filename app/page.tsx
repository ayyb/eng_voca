    ...
    <div className="min-h-screen bg-white">
      <div
        className="w-full max-w-md mx-auto h-screen flex flex-col p-8 
                      border border-gray-200 rounded-2xl shadow-lg bg-main"
      >
        {/* 상단 텍스트 영역 */}
        <div className="flex-1 flex flex-col justify-center">
          <div className="space-y-6">
            <p className="font-bold text-5xl sm:text-7xl text-white">Daily</p>
            <p className="font-bold text-5xl sm:text-7xl text-white">English</p>
            <p className="font-bold text-5xl sm:text-7xl text-white">Voca</p>
